...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/cl3kener/android/toolchain/uber/out/aarch64-linux-android-4.9/aarch64-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
